  ...
  function CourseRow({ course }) {
    ...
    return (
      <div className="grid grid-cols-[minmax(0,1.8fr)_0.8fr_0.8fr_0.8fr_0.45fr] items-center gap-4 border-t border-slate-100 px-5 py-4 text-sm text-slate-600">
        ...
        <div>
          <span
            className={`inline-flex rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] ${isLive
    ...
    <div className="space-y-8">
      <section className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-500 hover:scale-[1.02]"
        >
